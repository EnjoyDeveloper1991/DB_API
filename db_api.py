...
def PostUpdateUserInfo(user_id: str, user_nickname: str, user_gender: str, user_age: int, user_time: str):
    conn = DBConnect.DBConnect()
    if conn:
        result_json = DBConnect.PostUpdateUserInfo(conn, user_id, user_nickname, user_gender, user_age, user_time)
    return result_json
